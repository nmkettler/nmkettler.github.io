<?php include('header.php') ?>
  ...
  <div class="header alt vert img-responsive" id="imageRotator">
    <article class="introduction">
      ...
      <hgroup>
        ...
        <h5><span>I'm from Seattle, WA</span></h5>
      ...
      <div class="col-md-6">
        <figure class="gallery-item" id="item5">
          ...
          <figcaption class="img-title">
            ...
            <p>A custom built accordian menu that is mobile friendly. Ready to use on any website. Works in all major browsers. Jquery <a href="#" data-toggle="modal" data-target="#vertAcc" id="viewPop">View</a></p>
          </figcaption>
        </figure>
      </div>
      <div class="col-md-6">
 ...
 <!--Customer Websites Modal-->
  <div class="modal fade" id="siteMod" tabindex="-1" role="dialog" aria-labelledby="accModal">
        <div class="modal-dialog" role="document">    
            <div class="modal-body">
              <div class="scroll-pane ui-widget ui-widget-header ui-corner-all">
                <div class="scroll-content example-site-link">
                  <div class="scroll-content-item ui-widget-header"><a href="https://safe-atoll-65361.herokuapp.com/index.php"><img src="css/photos/Prep-Car-Image.png"></a></div>
                  <div class="scroll-content-item ui-widget-header"><a href="https://github.com/nmkettler/Dealership-Locator"><img src="css/photos/Dealer-Locator-Image.png"></a></div>
                  <div class="scroll-content-item ui-widget-header"><a href="https://serene-fjord-8357.herokuapp.com/index.php"><img src="css/photos/Salmon-Bay-Image.png"></a></div>
                  <div class="scroll-content-item ui-widget-header"><a href="https://frozen-stream-9514.herokuapp.com/"><img src="css/photos/FSX-Image.png"></a></div>
                </div>
